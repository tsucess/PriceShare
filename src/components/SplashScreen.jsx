  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          fontSize: '13px', letterSpacing: '5px', color: '#00e676',
      ...
      {/* TAGLINE */}
      <div style={{
        position: 'absolute', bottom: '60px', textAlign: 'center',
        opacity: stage === 'show' ? 1 : 0,
        transition: 'opacity 0.5s ease 0.4s',
      }}>
        <p style={{ fontSize: '13px', color: theme.dark ? 'rgba(255,255,255,0.35)' : 'rgba(0,0,0,0.35)', margin: 0 }}>
