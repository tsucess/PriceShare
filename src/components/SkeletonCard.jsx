...
export function SkeletonBlock({ width = '100%', height = '16px', borderRadius = '8px', delay = '0s', style = {} }) {
  ...
  return (
    <div style={{ background: theme.card, border: `1px solid ${theme.cardBorder}`, borderRadius: '16px', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '14px' }}>
        <SkeletonBlock width="60%" height="16px" delay="0s"   style={{ marginBottom: '10px' }} />
        <SkeletonBlock width="45%" height="12px" delay="0.1s" style={{ marginBottom: '8px' }} />
...
export function SkeletonStat() {
  const theme = useTheme();
  return (
    <div style={{ background: theme.card, border: `1px solid ${theme.cardBorder}`, borderRadius: '14px', padding: '16px' }}>
      <SkeletonBlock width="32px" height="32px" borderRadius="8px" style={{ marginBottom: '10px' }} />
      <SkeletonBlock width="50%" height="24px" delay="0.1s" style={{ marginBottom: '6px' }} />
...
export function SkeletonProduct() {
  const theme = useTheme();
  return (
    <div style={{ background: theme.card, border: `1px solid ${theme.cardBorder}`, borderRadius: '16px', padding: '18px', borderLeft: `3px solid ${theme.cardBorder}` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '14px' }}>
        <div>
          <SkeletonBlock width="140px" height="16px" style={{ marginBottom: '6px' }} />
          <SkeletonBlock width="90px"  height="11px" delay="0.1s" />
        </div>
        <SkeletonBlock width="70px" height="26px" borderRadius="6px" delay="0.1s" />
      </div>
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 18px', gap: '12px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1 }}>
        ...
        <div style={{ flex: 1 }}>
          <SkeletonBlock width="55%" height="14px" style={{ marginBottom: '6px' }} />
          <SkeletonBlock width="80%" height="11px" delay="0.1s" />
        </div>
      </div>
      <SkeletonBlock width="44px" height="24px" borderRadius="12px" delay="0.2s" />
    </div>
  );
}
